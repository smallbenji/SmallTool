...
$FilePath = if ($isAdmin) { "$env:SystemRoot\Temp\SmallTool_$rand.cmd" } else { "$env:TEMP\SmallTool_$rand.cmd" }
...
$FilePaths = @("$env:TEMP\SmallTool*.cmd", "$env:SystemRoot\Temp\SmallTool*.cmd")
